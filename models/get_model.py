...
# adds directory to python path so that we can import from there
# Here, 'prodigy' is added which is one level above the current directory
# This allows to seamlessly import from 'models' / 'experiments' / 'data'.
